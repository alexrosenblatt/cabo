...
def use_power(drawn_card_power: int,human_stack: Stack,computer_stack: Stack) -> bool:
    ...
    if drawn_card_power == 1: #TODO rewrite to show revealed card with table rather than sentence
        ...
        card_name,index_n = power_controller(drawn_card_power,human_stack,computer_stack,peek_index)
        #card_name:str = r[0]
        #index_n:int = r[1] 
        ...
        card_name, index_n = power_controller(drawn_card_power,human_stack,computer_stack,None,peek_index)
        #card_name = r[0]
        #index_n = r[1] 
